        ...
        <div className="auth-form">
            <div className="auth-switcher">
                <Button
                    ...
                    background="none"
                    color={`${switcherValue === "signin" ? "#000" : "gray"}`}
                    fontSize={20}
                    fontWeight="bold">
                    SIGN IN
                ...
                <Button
                    ...
                    background="none"
                    color={`${switcherValue === "signup" ? "#000" : "gray"}`}
                    fontWeight="bold"
                    fontSize={20}>
                    SIGN UP
            ...
            <div className="auth-fields center">{switcherValue === "signin" ? <SigninForm /> : <SignupForm />}</div>
            <div className="auth-form-btn">
                ...
                <Button
                    ...
                    style={{ marginTop: "2em", width: "70%", background: "#3a82ed" }}>
                    Sign in with Google
                </Button>
            </div>
        </div>
