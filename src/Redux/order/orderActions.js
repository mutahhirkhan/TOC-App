...
const stripePromise = loadStripe(
    "pk_test_51Ifio9FVd0QvRm2UuuE8VuZdPKI2DYxAgFThXhrS6KPrbxWRWEcXGNFu8n0kqCuFEwZrDNv3M4FRobXyrD1hAiMc00DPAUSlWG"
);
...
export var processOrder =
    ({ orderId, addressInfo, cart }) =>
    async (dispatch) => {
        try {
