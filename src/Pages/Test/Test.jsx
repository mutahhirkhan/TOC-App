...
const Test = ({ uploadProduct, uploadImages, openModal }) => {
    ...
    return (
        ...
        <div style={{ fontSize: "62.5%" }}>
            ...
            {/* <ProductCard /> */}
            <Button onClick={() => openModal({ modalType: "testModal", modalProps: { number: 2 } })}>open test modal</Button>
            <Button onClick={() => openModal({ modalType: "errorModal", modalProps: { error: "ops! </br> something went wrong " } })}>
                open error modal
            </Button>
